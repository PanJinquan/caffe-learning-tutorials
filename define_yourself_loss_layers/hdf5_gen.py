...
if __name__=='__main__':
    ...
    # image_mean_out=os.path.join(root_path, 'dataset/mean/train_mean.txt')#保存均值文件的路径
    train_labels_path='dataset/train.txt'#图像label文件的路径
    train_h5_out='dataset/HDF5/train.h5'#保存h5文件的目录
    image_mean_out='dataset/mean/train_mean.txt'#保存均值文件的路径
